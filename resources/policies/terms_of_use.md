...
The `Flexible Planner` app stores and processes on your device personal data that you have provided to us, to provide its services. It’s your responsibility to keep your phone and access to the app securely. We therefore recommend that you do not jailbreak or root your phone, which is the process of removing software restrictions and limitations imposed by the official operating system of your device. It could make your phone vulnerable to malware/viruses/malicious programs, compromise your phone’s security features and it could mean that the `Flexible Planner` app won’t work properly or at all.
...
E-mail: `smartreading.info@gmail.com`\
